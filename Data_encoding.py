...
def save_mix_drug_cell_matrix():
    ...
    pd.DataFrame(mut_id_test).to_csv("data/test_data/mut_id_test.csv")
    mut_cell_id_test = mut_cell_id[size1:]
    pd.DataFrame(mut_cell_id_test).to_csv("data/test_data/mut_cell_id_test.csv")

    meth_id_test = meth_id[size1:]
    pd.DataFrame(meth_id_test).to_csv("data/test_data/meth_id_test.csv")
    meth_cell_id_test = meth_cell_id[size1:]
    pd.DataFrame(meth_cell_id_test).to_csv("data/test_data/meth_cell_id_test.csv")

    ge_id_test = ge_id[size1:]
    pd.DataFrame(ge_id_test).to_csv("data/test_data/ge_id_test.csv")
    ge_cell_id_test = ge_cell_id[size1:]
    pd.DataFrame(ge_cell_id_test).to_csv("data/test_data/ge_cell_id_test.csv")
    ...
    pd.DataFrame(xd_test).to_csv("data/test_data/xd_test.csv")

    xc_ge_train = xc_ge[:size]
    xc_ge_val = xc_ge[size:]
    xc_ge_test = xc_ge[size2:]
    # pd.DataFrame(xc_ge_train).to_csv("data/test_data/xc_ge_train.csv")
    # pd.DataFrame(xc_ge_val).to_csv("data/test_data/xc_ge_val.csv")
    pd.DataFrame(xc_ge_test).to_csv("data/test_data/xc_ge_test.csv")

    xc_meth_train = xc_meth[:size]
    xc_meth_val = xc_meth[size:]
    xc_meth_test = xc_meth[size2:]
    ...
    pd.DataFrame(xc_meth_test).to_csv("data/test_data/xc_meth_test.csv")

    xc_mut_train = xc_mut[:size]
    xc_mut_val = xc_mut[size:]
    xc_mut_test = xc_mut[size2:]
    ...
    pd.DataFrame(xc_mut_test).to_csv("data/test_data/xc_mut_test.csv")
    ...
    pd.DataFrame(y_test).to_csv("data/test_data/y_test.csv")
